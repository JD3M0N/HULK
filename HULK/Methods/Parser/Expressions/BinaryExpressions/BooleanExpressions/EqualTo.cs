...
namespace HULK
{
    public class EqualTo : BinaryExpression
    {
        ...
        public EqualTo(Expression left, Expression right, TokenKind operation) : base(left, right, operation)
        {
            Kind = ExpressionKind.EqualTo;
            Operator = TokenKind.EqualsTo;
        }
