...
namespace HULK
{
    public class GreaterEqualThan : BinaryExpression
    {
        public override ExpressionKind Kind { get; set; }
        public override object? Value { get; set; }

        public GreaterEqualThan(Expression? left, Expression? right, TokenKind op) : base(left, right, op)
        {
            Kind = ExpressionKind.GreaterEqualThan;
            Operator = TokenKind.GreatherOrEquals;
        }
