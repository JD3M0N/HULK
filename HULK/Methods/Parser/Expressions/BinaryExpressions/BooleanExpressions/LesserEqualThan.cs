...
namespace HULK
{
    public class LesserEqualThan : BinaryExpression
    {
        public override ExpressionKind Kind { get; set; }
        public override object? Value { get; set; }

        public LesserEqualThan(Expression left, Expression right, TokenKind operation) : base(left, right, operation)
        {
            Kind = ExpressionKind.LesserEqualThan;
            Operator = TokenKind.LesserOrEquals;
        }
