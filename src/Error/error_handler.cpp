...
std::string ErrorMessage::getTypeString() const {
    switch (type) {
        ...
        case ErrorType::INTERNAL_ERROR: return "Internal Compiler Error";
...
std::string ErrorHandler::generateReport() const {
    ...
    for (const auto& error : errors) {
        switch (error.getType()) {
            case ErrorType::LEXICAL_ERROR:  lexicalErrors.push_back(error); break;
            case ErrorType::SYNTAX_ERROR:   syntaxErrors.push_back(error); break;
            case ErrorType::SEMANTIC_ERROR: semanticErrors.push_back(error); break;
            case ErrorType::TYPE_ERROR:     typeErrors.push_back(error); break;
            case ErrorType::SCOPE_ERROR:    scopeErrors.push_back(error); break;
            case ErrorType::CODEGEN_ERROR:  codegenErrors.push_back(error); break;
            case ErrorType::RUNTIME_ERROR:  runtimeErrors.push_back(error); break;
            case ErrorType::INTERNAL_ERROR: internalErrors.push_back(error); break;
        }
    }
